...
(function () {
  ...
  CKEDITOR.plugins.add('imagerotate', {
    lang: 'zh-cn,en,et',
    hidpi: true,
    icons: 'rotate-left.png,rotate-right.png,rotate-upsidedown.png', // is this line necessary?
    init: function (editor) {
	  ...
	  editor.addCommand('rotateUpSideDown', {
        exec: function (editor) {
          rotateSelectedImageByAngle(editor, 180);
        }
      });
      ...
      if (editor.contextMenu) {
        editor.addMenuItems({
		  ...
		  rotateUpSideDown: {
            label: translations.rotateUpSideDown,
            icon: this.path + 'icons/rotate-UpSideDown.png',
            command: 'rotateUpSideDown',
            group: 'image',
            order: 2
          }
        });
        ...
        editor.contextMenu.addListener(function (element, selection) {
          ...
          if (imageElement) {
            return {
			  ...
			  rotateUpSideDown: CKEDITOR.TRISTATE_OFF
            };
          }
        });
      }
